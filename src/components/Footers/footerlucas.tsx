import styles from "@/components/Footers/footerlucas.module.css"
        ...
        <footer className="py-16 px-8 bg-gray-900 md:py-8 divide-y">
            <div className = "flex justify-evenly py-10 md:py-5 flex-col gap-5 md:flex-row">
                ...
                <div className = "flex gap-10 text-white text-sm font-normal">
                    <a className="transition-colors cursor-pointer hover:text-primary-600 duration-400"
                  href="#"> OUR SERVICES </a>
                    <a className="transition-colors cursor-pointer hover:text-primary-600 duration-400"
                  href="#"> ABOUT US </a>
                    <a className="transition-colors cursor-pointer hover:text-primary-600 duration-400"
          ...
          <p className="py-4 text-center text-xs text-white"> Todos os direitos reservados © Ceos Jr. </p>
