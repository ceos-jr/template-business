...
import MemberCard3 from "./MemberCard3"

export type Members3Type = {
...
export default function App() {
  return (
    <>
      <div className="pb-24 w-full text-white bg-zinc-900">
        <div className="container flex flex-col gap-y-16 justify-center items-center py-16 px-8 mx-auto">
          <div className="text-center">
            ...
            <h2 className="pt-4 text-xl font-light text-gray-400">
