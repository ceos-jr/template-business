...
const CardJuia = ({
  ...
  return (
    <div className={`flex flex-col gap-4 items-center p-4 font-bold rounded-lg shadow-xl min-h-64  bg-yellow-200 transition-all ease-in-out duration-1000 ${className}`}
