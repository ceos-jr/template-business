...
const statistics: StatisticsCardProps[] = [
  ...
  { number: 949, name: "Hours Saved", speed: 0.5 },
  { number: 958, name: "Useful thing", speed: 0.2 },
  { number: 965, name: "Change", speed: 0.01 },
]

const StatisticsSection = () => {
  return (
    <section className="w-full bg-gradient-to-r from-cyan-500 to-blue-500">
      <div className="container grid grid-cols-1 gap-8 p-8 py-32 mx-auto md:grid-cols-1">
